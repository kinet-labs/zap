...
//   )
//
// Profile dispatch routes through kinet-labs/pq.ValidateMode:
//
...
//   }
//
// Same gate, same sentinel, same mode vocabulary as kinet-labs/warp,
// kinet-labs/dex, kinet-labs/fhe, kinet-labs/evm.
