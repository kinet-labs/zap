// mdns_discovery.go — Discovery backed by kinet-labs/mdns.
//
// The default Discovery used by Connect when no WithDiscovery override
// is supplied. Adapts kinet-labs/mdns to the package-level Discovery
// interface so callers depend on the contract, not on kinet-labs/mdns
...
// newMDNSDiscovery constructs a Discovery using kinet-labs/mdns. clientID
